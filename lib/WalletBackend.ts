...
export class WalletBackend extends EventEmitter {
     ...
     * the JSON to use, see https://github.com/traaittcash/wallet-file-interaction
     *
     ...
     * only wallet. For more information on subwallets, see https://docs.traaittcash.lol/developer/subwallets
     *
     * Example:
     * ```javascript
     ...
     * on a non view wallet. For more information on subwallets, see https://docs.traaittcash.lol/developer/subwallets
     *
     * Example:
     * ```javascript
