...
#### Master Build Status
[![Build Status](https://travis-ci.org/traaittcash/traaittcash-wallet-backend-js.svg?branch=master)](https://travis-ci.org/traaittcash/traaittcash-wallet-backend-js)
...
https://github.com/traaittcash/traaittcash-wallet-backend-js
...
`npm install https://github.com/traaittcash/traaittcash-wallet-backend-js --save`

Yarn:

`yarn add https://github.com/traaittcash/traaittcash-wallet-backend-js`

## Documentation

[You can view the documentation here](https://traaittcash.github.io/traaittcash-wallet-backend-js/classes/_walletbackend_.walletbackend.html)

You can see a list of all the other classes on the right side of the screen.
Note that you will need to prefix them all with `WB.` to access them, if you are not using typescript style imports, assuming you imported with `const WB = require('traaittcash-wallet-backend')`.

## Quick Start

You can find an [example project in the examples](https://github.com/traaittcash/traaittcash-wallet-backend-js/tree/master/examples/example1) folder.
...
`git clone https://github.com/traaittcash/traaittcash-wallet-backend-js.git`
